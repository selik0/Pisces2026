...
namespace GameEngine
{
    ...
    public static class TimerSystem
    {
        ...
        public static int Delay(float delay, Action callback)
        ...
        public static int Repeat(float interval, Action callback, int maxRepeat = 0)
        ...
        /// <param name="callback">回调，不可为 null</param>
        /// <param name="maxRepeat">最大触发次数，≤ 0 表示无限</param>
        public static int DelayRepeat(float delay, float interval, Action callback, int maxRepeat = 0)
